...
if __name__ == '__main__':
    ...
    # Genome with a single duplication
    dupl_genome = duplicateSection(MASTER_GENOME, 15000, 20000)
    with open('mds42_full_duplication.fa', 'w') as fd:
        fd.write(FASTA_BASE_STRING.format('duplication'))
        fd.write(dupl_genome)
        fd.write('\n')
